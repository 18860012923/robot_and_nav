...
int circle_time = 0;
ros::Time old_time;
void callback(const sensor_msgs::Imu::ConstPtr& imu,const nav_msgs::Odometry::ConstPtr& odom)//订阅/odom主题回调函数
{
    float x,y,fi,fi_imu,v_lin,v_gla;
    ros::Time odom_time_ = odom->header.stamp;
...
int main(int argc, char **argv)
{
    ...
    typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::Imu, nav_msgs::Odometry> testSyncPolicy;
	message_filters::Synchronizer<testSyncPolicy> sync(testSyncPolicy(10),imu_sub, odom_sub);// 同步
